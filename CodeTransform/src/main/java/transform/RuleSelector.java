...
public class RuleSelector {
    ...
    // static final int AddUnusedCode = 24;
    // static final int RenameMethodDecl = 25;
    ...
    static ASTVisitor create(String ruleIdStr, CompilationUnit cu_, Document document_, String outputDirPath_, ArrayList targetLines) {
        ...
        switch (ruleID) {
            ...
            // case AddUnusedCode:
            //     return new AddUnusedCode(cu_, document_, outputDirPath_, targetLines);
            // case RenameMethodDecl:
            //     return new RenameMethodDecl(cu_, document_, outputDirPath_);
            default:
