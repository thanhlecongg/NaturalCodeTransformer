...
public class Utils {
    ...
    public static String sublizeOutput(String filePath, String outputdir) {
        // return outpur file
    ...
    public static ExpressionStatement createPrintStmt(AST ast) {
        ...
        stringLiteral.setLiteralValue("__MASKED__");
        printlnMethodInvocation.arguments().add(stringLiteral);
    
        // Wrap the MethodInvocation in an ExpressionStatement
        ExpressionStatement expressionStatement = ast.newExpressionStatement(printlnMethodInvocation);
    ...
    public static IfStatement createDeadCode(AST ast){
        ...
        // Add the comment //_MASKED to the body of the IfStatement
        Block block = ast.newBlock();
        block.statements().add(createPrintStmt(ast));
